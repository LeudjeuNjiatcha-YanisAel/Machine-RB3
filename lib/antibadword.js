...
async function handleBadwordDetection(sock, chatId, message, userMessage, senderId) {
    ...
    const badWords = [
       "imbecile","chyeng","chien","enculer","modia","cu","merde","conard","salo","ton cu","bete","bet","connard","pute","fdp","pd","salope","encule","nique ta mere","ta mere","ta mère","nique ta mère","ta mère est une pute"
    ];
    
    const messageWords = cleanMessage.split(' ');
    let containsBadWord = false;
    console.log('Vérification des mots interdits dans le message :', messageWords);
